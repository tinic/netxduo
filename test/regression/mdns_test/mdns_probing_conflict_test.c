...
/* A conflicting A record for ARMMDNSTest.local (10.0.0.67). */
static const unsigned char host_conflict[87] = {
0x01, 0x00, 0x5e, 0x00, 0x00, 0xfb, 0x00, 0x11,
0x22, 0x33, 0x44, 0x57, 0x08, 0x00, 0x45, 0x00,
0x00, 0x49, 0x00, 0x01, 0x40, 0x00, 0xff, 0x11,
0x90, 0x64, 0x0a, 0x00, 0x00, 0x43, 0xe0, 0x00,
0x00, 0xfb, 0x14, 0xe9, 0x14, 0xe9, 0x00, 0x35,
0x00, 0x00, 0x00, 0x00, 0x84, 0x00, 0x00, 0x00,
0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x41,
0x52, 0x4d, 0x4d, 0x44, 0x4e, 0x53, 0x54, 0x65,
0x73, 0x74, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c,
0x00, 0x00, 0x01, 0x80, 0x01, 0x00, 0x00, 0x00,
0x78, 0x00, 0x04, 0x0a, 0x00, 0x00, 0x43
};
...
/* A response containing only a conflicting SRV record.  TXT must still
   follow the SRV owner when the complete unique publication is renamed. */
static const unsigned char srv_conflict[116] = {
0x01, 0x00, 0x5e, 0x00, 0x00, 0xfb, 0xec, 0x17,
0x2f, 0xbc, 0x39, 0x02, 0x08, 0x00, 0x45, 0x00,
0x00, 0x66, 0x05, 0x71, 0x00, 0x00, 0xff, 0x11,
0xcb, 0x19, 0x0a, 0x00, 0x00, 0x01, 0xe0, 0x00,
0x00, 0xfb, 0x14, 0xe9, 0x14, 0xe9, 0x00, 0x52,
0x00, 0x00, 0x00, 0x00, 0x84, 0x00, 0x00, 0x00,
0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x53,
0x69, 0x6d, 0x70, 0x6c, 0x65, 0x57, 0x65, 0x62,
0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x05, 0x5f,
0x68, 0x74, 0x74, 0x70, 0x04, 0x5f, 0x74, 0x63,
0x70, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x00,
0x00, 0x21, 0x80, 0x01, 0x00, 0x00, 0x00, 0x78,
0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50,
0x09, 0x43, 0x68, 0x65, 0x6e, 0x62, 0x6f, 0x2d,
0x50, 0x43, 0xc0, 0x27
};

/* A response containing only a conflicting TXT record for the renamed
   service.  Exhaustion must still report a service failure. */
static const unsigned char txt_conflict[104] = {
0x01, 0x00, 0x5e, 0x00, 0x00, 0xfb, 0xec, 0x17,
0x2f, 0xbc, 0x39, 0x02, 0x08, 0x00, 0x45, 0x00,
0x00, 0x5a, 0x05, 0x71, 0x00, 0x00, 0xff, 0x11,
0xcb, 0x25, 0x0a, 0x00, 0x00, 0x01, 0xe0, 0x00,
0x00, 0xfb, 0x14, 0xe9, 0x14, 0xe9, 0x00, 0x46,
0x00, 0x00, 0x00, 0x00, 0x84, 0x00, 0x00, 0x00,
0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x13, 0x53,
0x69, 0x6d, 0x70, 0x6c, 0x65, 0x57, 0x65, 0x62,
0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x20, 0x28,
0x32, 0x29, 0x05, 0x5f, 0x68, 0x74, 0x74, 0x70,
0x04, 0x5f, 0x74, 0x63, 0x70, 0x05, 0x6c, 0x6f,
0x63, 0x61, 0x6c, 0x00, 0x00, 0x10, 0x80, 0x01,
0x00, 0x00, 0x00, 0x78, 0x00, 0x02, 0x01, 0x78
};
...
MDNS_TEST_SEQ mdns_probing_conflict[] = {
    ...
    /* Inject response. */
    {INJECT, (char*)&srv_conflict[0], sizeof(srv_conflict), 0},

    /* Expect probing with other name. */
    {MDNS_CHECK_DATA_V4, (char*)&pkt3[0], sizeof(pkt3), 1},

    /* SRV, TXT and PTR must move to the new service instance together. */
    {MDNS_CHECK_SERVICE_OWNER_NAME, NX_NULL, 0, 0},
    ...
    /* A TXT-only conflict must report service publication failure. */
    {MDNS_SET_PROBING_CALLBACK_STATE, NX_NULL,
     NX_MDNS_LOCAL_SERVICE_REGISTERED_FAILURE, 0},
    {MDNS_SET_TXT_CONFLICT_LIMIT, NX_NULL, 0, 0},
    {INJECT, (char *)&txt_conflict[0], sizeof(txt_conflict), 0},
    {WAIT, NX_NULL, 0, 1},
    {MDNS_CHECK_PROBING_CALLBACK_INVOKED, NX_NULL, 0, 1},

    /* Exhaust the host retry budget and provoke one final A conflict. */
    {MDNS_SET_PROBING_CALLBACK_STATE, NX_NULL,
     NX_MDNS_LOCAL_HOST_REGISTERED_FAILURE, 0},
    {MDNS_SET_HOST_CONFLICT_LIMIT, NX_NULL, 0, 0},
    {INJECT, (char *)&host_conflict[0], sizeof(host_conflict), 0},
    {WAIT, NX_NULL, 0, 1},
